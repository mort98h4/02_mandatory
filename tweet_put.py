...
def _(language = "en", id=""):
    ...
    try:
        ...
        if request.files.get("tweet_image_src"):
            ...
            tweet_image_src = tweet['tweet_image_src']
        if not tweet["tweet_image_src"] == tweet_image_src or tweet["tweet_image_src"] != "":
            # REMEMBER TO DELETE OLD IMAGE
            print(tweet_image_src)
            print(tweet["tweet_image_src"])
